          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="LOCATION_BARCODE" value="<?php echo $this->input->post('LOCATION_BARCODE'); ?>" class="form-control" id="LOCATION_BARCODE" />
						</div>
					</div>-->
					<div class="col-md-6">
						<label for="LOCATION_BUILDING_ID" class="control-label">LOCATION BUILDING ID</label>
						<div class="form-group">
							<input type="text" name="LOCATION_BUILDING_ID" value="<?php echo $this->input->post('LOCATION_BUILDING_ID'); ?>" class="form-control" id="LOCATION_BUILDING_ID" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="LOCATION_BUILDING_NAME" class="control-label">LOCATION BUILDING NAME</label>
						<div class="form-group">
							<input type="text" name="LOCATION_BUILDING_NAME" value="<?php echo $this->input->post('LOCATION_BUILDING_NAME'); ?>" class="form-control" id="LOCATION_BUILDING_NAME" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="LOCATION_FLOOR_ID" class="control-label">LOCATION FLOOR ID</label>
						<div class="form-group">
							<input type="text" name="LOCATION_FLOOR_ID" value="<?php echo $this->input->post('LOCATION_FLOOR_ID'); ?>" class="form-control" id="LOCATION_FLOOR_ID" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="LOCATION_ROOM_ID" class="control-label">LOCATION ROOM ID</label>
						<div class="form-group">
							<textarea name="LOCATION_ROOM_ID" class="form-control" id="LOCATION_ROOM_ID"><?php echo $this->input->post('LOCATION_ROOM_ID'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
