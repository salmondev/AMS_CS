    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">History Asset Recent Add</h3>
            </div>
            <?php echo form_open('history_asset_recent/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="HISTORY_ASSET_NAME" class="form-control" id="HISTORY_ASSET_NAME"><?php echo $this->input->post('HISTORY_ASSET_NAME'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_RECEIVEDATE" class="control-label">HISTORY RECEIVEDATE</label>
						<div class="form-group">
							<textarea name="HISTORY_RECEIVEDATE" class="form-control" id="HISTORY_RECEIVEDATE"><?php echo $this->input->post('HISTORY_RECEIVEDATE'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_SPEC" class="control-label">HISTORY SPEC</label>
						<div class="form-group">
							<textarea name="HISTORY_SPEC" class="form-control" id="HISTORY_SPEC"><?php echo $this->input->post('HISTORY_SPEC'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_UNITNAME" class="control-label">HISTORY UNITNAME</label>
						<div class="form-group">
							<textarea name="HISTORY_UNITNAME" class="form-control" id="HISTORY_UNITNAME"><?php echo $this->input->post('HISTORY_UNITNAME'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="HISTORY_REFERNAME" class="form-control" id="HISTORY_REFERNAME"><?php echo $this->input->post('HISTORY_REFERNAME'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="HISTORY_ROOM_ID" class="form-control" id="HISTORY_ROOM_ID"><?php echo $this->input->post('HISTORY_ROOM_ID'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_USERNAME" class="control-label">HISTORY USERNAME</label>
						<div class="form-group">
							<textarea name="HISTORY_USERNAME" class="form-control" id="HISTORY_USERNAME"><?php echo $this->input->post('HISTORY_USERNAME'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_NOTE" class="control-label">HISTORY NOTE</label>
						<div class="form-group">
							<textarea name="HISTORY_NOTE" class="form-control" id="HISTORY_NOTE"><?php echo $this->input->post('HISTORY_NOTE'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
