    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Floor Add</h3>
            </div>
            <?php echo form_open('floor/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="BUILDING_ID" class="form-control">
								...
								{
									$selected = ($building['BUILDING_ID'] == $this->input->post('BUILDING_ID')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="FLOOR_ID" value="<?php echo $this->input->post('FLOOR_ID'); ?>" class="form-control" id="FLOOR_ID" />
						</div>
					</div>
				</div>
			</div>
