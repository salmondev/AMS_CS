          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="HISTORY_ASSET_NAME" value="<?php echo $this->input->post('HISTORY_ASSET_NAME'); ?>" class="form-control" id="HISTORY_ASSET_NAME" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_RECEIVEDATE" class="control-label">HISTORY RECEIVEDATE</label>
						<div class="form-group">
							<input type="text" name="HISTORY_RECEIVEDATE" value="<?php echo $this->input->post('HISTORY_RECEIVEDATE'); ?>" class="form-control" id="HISTORY_RECEIVEDATE" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_SPEC" class="control-label">HISTORY SPEC</label>
						<div class="form-group">
							<input type="text" name="HISTORY_SPEC" value="<?php echo $this->input->post('HISTORY_SPEC'); ?>" class="form-control" id="HISTORY_SPEC" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="HISTORY_UNITNAME" class="control-label">HISTORY UNITNAME</label>
						<div class="form-group">
							<input type="text" name="HISTORY_UNITNAME" value="<?php echo $this->input->post('HISTORY_UNITNAME'); ?>" class="form-control" id="HISTORY_UNITNAME" />
						</div>
					</div>
					<div class="col-md-6">
