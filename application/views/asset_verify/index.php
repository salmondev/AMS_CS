			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header">
						...
						<div class="box-title">
							<a href="<?php echo site_url('asset_verify/add'); ?>" class="btn btn-success btn-lg"><i
					...
					<div class="box-body">
						<table id="example2" class="table table-striped table-bordered">
							...
							<tr>
								...
								<td>
									<a href="<?php echo site_url('asset_verify/edit/'.$A['ASSET_VERIFY_RID']); ?>"
										class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a>
									<a href="<?php echo site_url('asset_verify/remove/'.$A['ASSET_VERIFY_RID']); ?>"
