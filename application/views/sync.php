	...
	<script type="text/javascript">
		$(document).ready(function () {
			$('#btnGetSelectedSkills').click(function () {
				getSelectedCheckBoxes('check_list');
			});
			/*
...
<div class="container box">
	<div id="divResult">
		<br />
		<input id="btnGetSelectedSkills" type="submit" value="Get Selected QR" />
		...
		<div class="table-responsive">
			...
			<table id="example2" class="table table-striped table-bordered">
				<thead>
					<tr>
						<th>PRINT QR <input name="CheckAll" type="checkbox" id="CheckAll" value="Y"
								onClick="ClickCheckAll(this);"></th>
						<th>ASSETID</th>
						<th>BARCODE</th>
						<th>REFERIDITEM</th>
						<th>ASSETNAME</th>
				...
				<tr>
					<td>
						<input type="checkbox" name="check_list[0]" value="<?php echo $A['BARCODE']; ?>">
						<?php $i++ ?>
					</td>
					<td>
						<?php echo $A['ASSETID']; ?>
